...
## Second exponential distribution example; sample size 15, rate .2

```{r ExpBootstrapl}
# Exponenial bootstrap
R <- 1000                                    # R: number of replications
bootmean <- numeric(R)                       # bootmean: vector of mean values w R values
x <- rexp(n=15, rate = .2)                    # X: vector containing the sample to bootstrap
...
```
* QQPlot - mean values conform to the diagonal of the qqplot, about as well as for normal distribution